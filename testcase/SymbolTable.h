...
public:
	...
	void inorder(symbolTree *t, symbol *n, int &i, int &num_splay);
	
	void preorder(symbolTree *t, symbol *n);
	
	int lookup(symbolTree *t, symbol *n, string name, int &num_splay, int &num_comp);
	...
	symbol *find_name(symbolTree *t, symbol *n, string name);
	
	int is_Valid_type(symbol *n, string value);
	
	int isOtherSymbol(string str);
	
	int assign(symbolTree *t, symbol *n, string name, string value);
